                                ...
                                <div>
                                    ...
                                    {acid === '128' ? (
                                        <div className={style.condition} style={{width: "80%"}}>
                                            ...
                                            <div className={style.p_container}>
                                                <p>4、</p>
                                                <p>2018年7月15日之后在白熊平台发布的作品，均可以参赛；</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>5、</p>
                                                <p>投稿作品必须为原创作品，不接受任何盗用他人素材内容的作品，一经发现作品存在抄袭或版权问题，取消参赛资格；</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>6、</p>
                                                <p>投稿作品、标题健康和谐，不涉及色情、暴力以及和国家法律相抵触的内容。带有商业推广意图的广告内容，不和谐内容等视为无效作品；</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>7、</p>
                                                <p>未经主办方同意，参赛者在参赛期间不得将参赛作品自行用于商业用途或授予任何第三方使用，不得用参赛作品参与与本赛事相同或类似的其他活动，且需遵守其他活动规则内容，否则取消获奖资格</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>8、</p>
                                                <p>作品版权归作者所有，投稿即视作允许主办方在相关专题、官网、微博、微信等公众渠道署名推广。</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>9、</p>
                                                <p>本活动最终解释权归“白熊阅读”所有。</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className={style.condition} style={{width: "80%"}}>
                                            ...
                                            <div className={style.p_container}>
                                                <p>2、</p>
                                                <p>至截止收稿日（2018年9月20日24点），篇幅需达到10w字；</p>
                                            </div>
                                            <div className={style.p_container}>
                                                <p>3、</p>
                                                <p>参赛作品须为白熊阅读独家首发；</p>
